    ...
    if (!isset($_SESSION['customerNumber'])) {
        if (isset($_POST['submit'])) {
            ...
            if (!empty($user_username) && !empty($user_password)) {
                ...
                $query = "SELECT customerNumber, username FROM customers WHERE username = '$user_username' AND password = MD5('$user_password')";
                ...
                if (mysqli_num_rows($data) == 1) {
                    ...
                    setcookie('customerNumber', $row['customerNumber'], time() + (60 * 60 * 24 * 10));    // expires in 10 days
...
<head>
    <meta charset="UTF-8">
    <title>Lesson 5 - Log In</title>
    <link rel="stylesheet" type="text/css" href="style.css">
</head>
<body>
    <h3>Lesson 5 - Log In</h3>
